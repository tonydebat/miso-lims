...
public class ContainerControllerHelperService {
  ...
  public JSONObject changeContainer(HttpSession session, JSONObject json) {
    try {
      ...
      case ILLUMINA:
        return changeIlluminaContainer(session, platform, json);
      case LS454:
        return changeLS454Container(session, platform, json);
      case SOLID:
        return changeSolidContainer(session, platform, json);
      case PACBIO:
        return changePacBioContainer(session, platform, json);
      default:
  ...
  private JSONObject changeIlluminaContainer(HttpSession session, Platform platform, JSONObject json) {
    StringBuilder b = new StringBuilder();
  ...
  private JSONObject changeLS454Container(HttpSession session, Platform platform, JSONObject json) {
    StringBuilder b = new StringBuilder();
  ...
  public JSONObject changeSolidContainer(HttpSession session, Platform platform, JSONObject json) {
    StringBuilder b = new StringBuilder();
  ...
  private JSONObject changePacBioContainer(HttpSession session, Platform platform, JSONObject json) {
    StringBuilder b = new StringBuilder();
